...
public class piirrapallo extends JPanel{
        ...
        //Pallon tiedot
        private float x = 0, y = 0, kulmaX = 0, kulmaY = 0,sade = 20, massa = 0, kasvu=2, gravity = (float)9.81, gravityeffect,kimmoike = 2, centerX,centerY,vauhti,Xsijainti,Ysijainti,muisti;
